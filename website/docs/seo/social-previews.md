...
2. Describe what you want for the page, for example: "Set the social link preview for my Home page. Title: Northstar Scheduling. Description: Scheduling software for multi-location clinics. Book a demo in two minutes. Use our logo as the preview image."
