...
2. Tell Kite which page and what you want, for example: "Set the page title on our Pricing page to: Clinic Scheduling Software Pricing | Northstar."
...
2. Tell Kite, for example: "Set the meta description on our Home page to: Scheduling software for multi-location clinics. Cut front-desk phone time in half. Book a demo."
...
1. Point Kite to the image and describe it plainly, for example: "Add alt text to the hero image on our Home page: A clinic receptionist confirming an appointment in Northstar."
